...
let serverConfig = {
    ...
    // local_URL : "",
    // local_URL : "http://viewer.usgs.northernhorizon.org",

    //upload path to geoserver when approved
    geoServer : 'http://cs.northernhorizon.org:8080/geoserver/',
    ...
    Download_From : 'https://cors.northernhorizon.org:9084/http://cs.northernhorizon.org:8080/geoserver/ows?service=wms&version=1.3.0&request=GetCapabilities',
    ...
    influx:{
        precision: 'rfc3339',
        // host: 'influx.northernhorizon.org',
